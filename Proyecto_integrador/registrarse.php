...
<body class="inicioSesion">
    ...
    <div class="containerForm">
        <form class="formInicioSesion" method="post" action="" onsubmit="return validarFormularioCrear()">
            ...
            <input type="text" id="nombre_pacientes" name="nombre_pacientes" required>

            <br><br>

            <label for="apellidos_pacientes">Apellidos:</label>
            <input type="text" id="apellidos_pacientes" name="apellidos_pacientes" required>
            ...
            <input type="email" id="mail_pacientes" name="mail_pacientes" required>

            <br><br>

            <label for="usuario_pacientes">Nombre de Usuario:</label>
            <input type="text" id="usuario_pacientes" name="usuario_pacientes" required>

            <br><br>

            <label for="contrasena_pacientes">Contraseña:</label>
            <input type="password" id="contrasena_pacientes" name="contrasena_pacientes" required>
