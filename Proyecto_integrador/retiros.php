    ...
    <main>
            ...
            <div class="tarjetasRetiros">
                <div class="retiros">
                    ...
                    <p>Escapa de la rutina y redescubre tu bienestar en nuestro Retiro de Verano al Aire Libre.
                        ...
                        salud mental,
                        combinando la serenidad del entorno natural con actividades que nutren el alma. Desde yoga al
                        amanecer hasta meditación al atardecer,
                        cada momento está diseñado para fomentar la paz interior y la atención plena.
                        Bajo la guía de expertos en bienestar, explorarás técnicas de mindfulness y participarás en
                        talleres
                        que promueven el equilibrio emocional y mental. Las caminatas por la naturaleza, los baños en
                        aguas frescas
                        y los momentos de reflexión personal se combinan para ofrecerte una experiencia profundamente
                        revitalizante.
                    </p>
                    <div class="detalles-retiros">
                        ...
                        <button type="button" name="VolverIndex"
                            onclick="window.location.href='reservaEvento.php';">¡Apúntate!</button>
                    </div>
            ...
            <div class="tarjetasRetiros">
                <div class="retiros">
                    ...
                    <p>
                        ...
                        Invierno,
                        un santuario lejos del ajetreo de la vida cotidiana. En el corazón de un paisaje invernal
                        sereno,
                        ...
                        Nuestro programa está meticulosamente planeado para incluir actividades que calientan el cuerpo
                        y el alma,
                        desde sesiones de yoga frente a la chimenea hasta meditaciones guiadas que reflejan la quietud
                        del paisaje invernal.
                        Cada momento está pensado para promover una sensación de paz y bienestar,
                        ayudándote a cultivar la atención plena y la serenidad en medio de la majestuosa naturaleza
                        invernal.
                    </p>
                    <div class="detalles-retiros">
                        <span>🛒 Precio: 80€</span>
        ...
        <div class="faq-container" id="preguntasRespuestas">
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p> El precio generalmente incluye alojamiento, todas las comidas (desayuno, almuerzo y cena),
                        acceso a todas las actividades programadas (yoga, meditación, talleres de mindfulness, etc.), y
                        el uso de las instalaciones del retiro. Cualquier servicio o actividad extra será especificado
                        en la descripción del paquete.</p>
                </div>
            </div>

            <div class="faq-item">
                <h2 class="faq-question">¿Qué debo llevar al retiro? <span class="faq-icon">▶</span>
                </h2>
                <div class="faq-answer">
                    <p>Recomendamos traer ropa cómoda para las actividades de yoga y meditación, ropa adecuada para el
                        clima, artículos personales, una botella de agua reutilizable, y cualquier medicamento o
                        necesidad personal específica. Te enviaremos una lista de empaque detallada una vez que hayas
                        confirmado tu reserva.</p>
                </div>
            </div>

            <div class="faq-item">
                <h2 class="faq-question">¿Puedo asistir al retiro solo/a? <span class="faq-icon">▶</span>
                </h2>
                <div class="faq-answer">
                    <p>Absolutamente, muchos de nuestros huéspedes asisten solos. Es una excelente oportunidad para
                        conocer a nuevas personas con intereses similares en un ambiente seguro y acoge</p>
                </div>
            </div>

            <div class="faq-item">
                <h2 class="faq-question">¿Necesito tener experiencia previa en yoga o meditación para asistir? <span
                        class="faq-icon">▶</span>
                </h2>
                <div class="faq-answer">
                    <p> No, nuestros retiros están diseñados para acoger tanto a principiantes como a practicantes
                        avanzados. Ofrecemos instrucciones y adaptaciones para asegurar que todos puedan participar
                        cómodamente.</p>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p> Ofrecemos una variedad de opciones de alojamiento que van desde habitaciones compartidas hasta
                        suites privadas. Las descripciones detalladas y fotos de las opciones de alojamiento están
                        disponibles bajo petición.</p>
                </div>
            </div>


            <div class="faq-item">
                <h2 class="faq-question">¿Hay tiempo libre para explorar el área circundante? <span
                        class="faq-icon">▶</span>
                </h2>
                <div class="faq-answer">
                    <p>Sí, aunque nuestro programa es completo y diseñado para ofrecerte una experiencia profundamente
                        revitalizante, también entendemos la importancia del tiempo personal. Programamos tiempo libre
                        cada día para que puedas explorar los alrededores, relajarte en las instalaciones del retiro o
                        disfrutar de actividades opcionales adicionales, según tus intereses.</p>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>Nuestros retiros están diseñados para acomodar a personas de todos los niveles de fitness. Las
                        actividades físicas como el yoga y las caminatas se adaptan para diferentes niveles de
                        habilidad. Si tienes preocupaciones específicas sobre tu condición física o limitaciones, por
                        favor comunícate con nosotros antes de reservar para discutir cómo podemos satisfacer tus
                        necesidades.</p>
                </div>
            </div>
        </div>
