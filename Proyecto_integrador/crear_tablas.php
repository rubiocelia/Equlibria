...
$sql_pacientes = "CREATE TABLE IF NOT EXISTS pacientes (
    ...
    nombre_pacientes VARCHAR(255)  NULL,
    usuario_pacientes VARCHAR(255) NULL,
    apellidos_pacientes VARCHAR(255) NULL,
    contrasena_pacientes VARCHAR(255) NULL,
    telefono_paciente VARCHAR(255) NULL,
